(() => {
  "use strict";
  const FALLBACK_DATA = {"lastUpdated":"2026-09-14T21:47:00+03:00","live":false,"sourceMode":"local-json","news":[{"id":"gta6-extended-look-2026-08-27","title":"Grand Theft Auto VI: العرض الموسّع متاح الآن","description":"نشرت Rockstar Games عرضًا موسعًا جديدًا لـ Grand Theft Auto VI بتاريخ 27 أغسطس 2026، يتضمن لقطات ملتقطة من داخل اللعبة على PlayStation 5.","game":"GTA VI","date":"2026-08-27","source":"Rockstar Games","sourceURL":"https://www.rockstargames.com/VI/an-extended-look","official":true},{"id":"gta-online-business-rivalries-2026-09-03","title":"GTA Online: منافسات الأعمال تبدأ خلال سبتمبر","description":"أعلنت Rockstar Games فعالية Business Rivalries في GTA Online، مع تركيز على الأنشطة التجارية خلال شهر سبتمبر 2026.","game":"GTA Online","date":"2026-09-03","source":"Rockstar Games","sourceURL":"https://www.rockstargames.com/newswire/article/ak43aoa18a19o2/compete-across-entrepreneurial-endeavors-in-the-gta-online-business-ri","official":true},{"id":"rdo-moonshine-2026-09-01","title":"Red Dead Online: مكافآت ثلاثية لنشاط Moonshiner","description":"أعلنت Rockstar Games عن مكافآت ثلاثية مرتبطة بنشاط Moonshiner في Red Dead Online، إلى جانب مكافآت وعناصر محدودة الوقت.","game":"Red Dead Online","date":"2026-09-01","source":"Rockstar Games","sourceURL":"https://www.rockstargames.com/newswire/article/39a24772831aa7/distill-your-best-swill-for-triple-rewards-in-red-dead-online","official":true},{"id":"gta6-preorder-2026-06-24","title":"Grand Theft Auto VI: الطلب المسبق متاح","description":"توضح صفحة GTA VI الرسمية تفاصيل الطلب المسبق، وتؤكد أن اللعبة قادمة إلى PlayStation 5 وXbox Series X|S.","game":"GTA VI","date":"2026-06-24","source":"Rockstar Games","sourceURL":"https://www.rockstargames.com/VI","official":true},{"id":"gta6-release-2025-11-06","title":"Grand Theft Auto VI: موعد الإصدار المؤكد حاليًا","description":"صفحة GTA VI الرسمية تعرض حاليًا موعد الإصدار في 19 نوفمبر 2026، مع المنصات المدعومة PlayStation 5 وXbox Series X|S.","game":"GTA VI","date":"2025-11-06","source":"Rockstar Games","sourceURL":"https://www.rockstargames.com/VI","official":true}]};
  const data = (window.ROCK_NEWS_DATA && Array.isArray(window.ROCK_NEWS_DATA.news) && window.ROCK_NEWS_DATA.news.length) ? window.ROCK_NEWS_DATA : FALLBACK_DATA;
  const games = [
  ...
  function init(){
    if (!data.news || !Array.isArray(data.news)) {
      data.news = [];
      console.error("ROCK NEWS AR: تعذر تحميل بيانات الأخبار.");
    }
